...
public class HeroFilterSelectionAdapter extends ArrayAdapter<HeroListItem> {
	...
	public HeroFilterSelectionAdapter(Context context, int resource,List<HeroListItem> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.hero_filters_selection_row, null);
			...
			holder.heroName = (TextView) convertView.findViewById(R.id.heroFiltersSelectionRow_HeroName);
			holder.heroPic = (RoundedImageView) convertView.findViewById(R.id.heroFiltersSelectionRow_HeroPic);
